...
#include "vector - 1083520 - hw7-3.h" // include definition of class template vector
#include "list - 1083520 - hw7-3.h"   // include definition of class template list
...
HugeInteger< T > HugeInteger< T >::operator/(HugeInteger &op2)
{
	...
	typename T::reverse_iterator rIt = quotient.integer.rbegin();
	for (int k = quotientSize - 1; k >= 0; k--, ++rIt) {
